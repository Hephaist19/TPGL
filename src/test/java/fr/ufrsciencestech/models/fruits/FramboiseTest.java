 ...
 * @author jl336673
 */
public class FramboiseTest extends FruitTest {
    @Override
    public Fruit createInstance() {
        return new Framboise(0.5, "Espagne");
    }

    public FramboiseTest() {
        super.setUp();
    }
    ...
    public void testToString() {
        ...
        String expResult = "Framboise de Espagne à 0.5 euros";
    ...
    public void testEquals() {
        ...
        // Test egal
        Fruit o = new Framboise(0.5, "Espagne");
